<div class="panel panel-body">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6">
            ...
            <div class="dash-square bg-nav">{{ $tournamentsCreated->count() }}
                <div class="text-size-large text-uppercase">{{ trans('core.created') }}</div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
            <div class="dash-square bg-secondary">{{ $tournamentsParticipated->count()  }}
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6">
            <div class="dash-square bg-primary">{{ $tournamentsParticipated->where('dateFin','<', new \DateTime('today'))->count() }}
                <div class="text-size-large text-uppercase">{{ trans('core.past') }}</div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
            <div class="dash-square bg-success">{{ $tournamentsParticipated->where('dateFin','>=', new \DateTime('today'))->count() }}
